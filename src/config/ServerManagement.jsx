                      ...
                      <td className="p-3 flex gap-2">
                        {editingServer?.id === item.id ? (
                          ...
                          <>
                            ...
                            <button
                              onClick={() => setDeleteConfirm({ id: item.id, ip_address: item.ip_address })}
        ...
        <Dialog
          ...
          onConfirm={async () => {
            try {
              ...
              deleteFormData.append('id', deleteConfirm.id);
              deleteFormData.append('ip_address', deleteConfirm.ip_address);
